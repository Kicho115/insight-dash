    ...
    <div className={styles.container}>
      <div className={styles.header}>
        <div className={styles.headerLeft}>
          {ext === "xlsx" ? (
            <div className={`${styles.fileIcon} ${styles.excel}`}><BsFiletypeXlsx /></div>
          ) : (
            <div className={`${styles.fileIcon} ${styles.csv}`}><BsFiletypeCsv /></div>
          )}
      ...
      <div className={styles.summary}>
        ...
        <p className={styles.summaryText}>{file.summary ?? "No summary available."}</p>
      </div>
